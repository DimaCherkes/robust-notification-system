package com.dmitrycherkes.weatherservice.config;
...
public class AwsConfig {
     ...
     * Uses StaticCredentialsProvider for local/docker profiles (with keys)
     * and DefaultCredentialsProvider for AWS environments (using IAM Roles).
     */
    @Bean
